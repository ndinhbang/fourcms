...
import DeleteEntryConfirmation from '../collections/DeleteEntryConfirmation.vue';
import DeleteLocalizationConfirmation from '../collections/DeleteLocalizationConfirmation.vue';
